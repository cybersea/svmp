...
svmp_all_sites_file = "svmp_all_sites_041309_samptype.shp"
...
site_characteristics =  spatial.TableQuery(gp,svmp_all_sites_file,samp_type_qry)
...
flStratum = svmp.FlatsStratum(svmp.fl_extrap[0],svmp.fl_extrap[1])
...
# -- Fringe Stratum
frStratum = svmp.FringeStratum(svmp.fr_extrap[0],svmp.fr_extrap[1])
...
# -- Wide Fringe Stratum    
frwStratum = svmp.FringeStratum(svmp.frw_extrap[0],svmp.frw_extrap[1])
